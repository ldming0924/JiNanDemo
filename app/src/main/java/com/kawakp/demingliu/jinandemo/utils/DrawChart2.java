 ...
 */
public class DrawChart2 extends View {
    ...
    public DrawChart2(Context context) {
        this(context,null);
    }

    public DrawChart2(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DrawChart2(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void drawTable(Canvas canvas){
        ...
        //画左侧数字
        canvas.drawText(3+"", OFFSET_LEFT - TEXT_OFFSET -5, OFFSET_TOP+10, paint);
       // for(int i = 1 ; i<10 ; i++){
            //float f = (float) 0.3*i;
           // Log.d("FLOAT",f+"   ");
           // canvas.drawText(0.3+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(i), paint);
            canvas.drawText(0.3+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(1), paint);
            canvas.drawText(0.6+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(2), paint);
            canvas.drawText(0.9+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(3), paint);
            canvas.drawText(1.2+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(4), paint);
            canvas.drawText(1.5+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(5), paint);
            canvas.drawText(1.8+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(6), paint);
            canvas.drawText(2.1+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(7), paint);
            canvas.drawText(2.4+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(8), paint);
            canvas.drawText(2.7+"", OFFSET_LEFT - TEXT_OFFSET-5, CHARTH-100-( CHARTH-OFFSET_TOP-100)/10*(9), paint);
       // }
    ...
    private void prepareLine(double y){
        ...
        double f = ((double) y)/3; //计算y占y轴最大值得比值，表示将表格分成200份，每份有多少
        double f1 = 1- f;
